 ...
 * @author Bananahanack
 */
class Maritina_RatesViewArchive extends JViewLegacy
{
	...
	public function display( $tpl = null )
	{
		...
		$this->canDo = maritina_ratesHelper::getActions( 'archive' );
		$this->_setToolBar();
		parent::display( $tpl );
	}
	...
	protected function _setToolBar()
	{
		...
		$canDo = maritina_ratesHelper::getActions( 'archive', $this->item->id );
        JToolBarHelper::title('Rates Request');
//		JToolBarHelper::title( JText::_( 'COM_MARITINA_RATES' ) . ': <small>[ ' . ( $isNew ? JText::_( 'JTOOLBAR_NEW' ) : JText::_( 'JTOOLBAR_EDIT' ) ) . ']</small>' );
		// For new records, check the create permission.
		if ( $isNew && ( count( $this->user->getAuthorisedCategories( 'com_maritina_rates', 'core.create' ) ) > 0 ) ) {
