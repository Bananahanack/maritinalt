<?php
/** @var $this Maritina_RatesViewArchive */
...
<form action="<?php echo JRoute::_( 'index.php?option=com_maritina_rates&id=' . $this->form->getValue( 'id' ) ); ?>" method="post" name="adminForm" id="item-form" class="form-validate" enctype="multipart/form-data">
