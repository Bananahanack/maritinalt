<?php
/** @var $this Maritina_RatesViewArchives */
...
if ( $saveOrder ) {
	$saveOrderingUrl = 'index.php?option=com_maritina_rates&task=archives.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_( 'index.php?option=com_maritina_rates&view=archives' ); ?>" method="post" name="adminForm" id="adminForm">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="articleList">
				...
				<?php foreach ( $this->items as $i => $item ) :
					...
					$canEdit = $user->authorise( 'core.edit', '#__rmaritina_rates.' . $item->id );
					$canCheckin = $user->authorise( 'core.manage', 'com_maritina_rates' ) || $item->checked_out == $userId || $item->checked_out == 0;
					$canEditOwn = $user->authorise( 'core.edit.own', '#__rmaritina_rates.' . $item->id ) && $item->created_by == $userId;
					$canChange = $user->authorise( 'core.edit.state', '#__rmaritina_rates.' . $item->id ) && $canCheckin;
					?>
						...
						<td class="nowrap has-context">
							<div class="pull-left">
								<?php if ( $canEdit || $canEditOwn ) : ?>
									<a href="<?php echo JRoute::_( 'index.php?option=com_maritina_rates&task=archive.edit&id=' . $item->id ); ?>" title="<?php echo JText::_( 'JACTION_EDIT' ); ?>">
